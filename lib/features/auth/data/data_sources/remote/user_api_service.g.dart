...
class _UserApiService implements UserApiService {
  _UserApiService(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://blogspot-backend-wvyq.onrender.com/user/';
  }
  ...
  @override
  Future<HttpResponse<bool>> sendOtp(String email) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<bool>> verifyOtp(String email, String otp) async {
    final _extra = <String, dynamic>{};
